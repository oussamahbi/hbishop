...
setInterval(() => {
    http.get(`http://hbishop.glitch.me`);
}, 280000);
...
let SFAP = 15000; /*سعر الحساب الواحد الفل داتا*/
let NFAP = 3000; /*سعر الحساب الواحد العادي*/
let URID = '471429393097424897' //مين بيتحوله الكريديت
client.on('message', async message => { 
    ...
    if (message == prefix + 'stock') {
        ...
        message.channel.send(new Discord.RichEmbed().setTitle('💵 # . HBI $ 💵') ///1
